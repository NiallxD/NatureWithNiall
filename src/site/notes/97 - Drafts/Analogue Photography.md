---
{"dg-publish":true,"dg-permalink":"analogue-photography","permalink":"/analogue-photography/","title":"Analogue Photography","metatags":{"og:title":"{{title}}","og:description":"{{description}}","og:image":"{{header-image}}"},"hide":true,"tags":["blog","photography","analogue","analoguephotography"],"noteIcon":null,"created":"2024-05-02T22:18:40.381+01:00","updated":"2024-05-03T00:09:00.761+01:00"}
---
...
This is version two of an article from an old blog post I wrote on my previous iteration of niallbell.com. It's a fairly long one reflecting on my personal adventure into film photography and my motivations for doing so.
...
*The Owners Handbook that came with the camera.*
...
*A photograph of a box of Kentmere 400 B&W with a post-it*
...
*A brick wall. Actually, my brick wall.*

### Shooting My Second Roll

This is where I started to put some effort in. I was thrown into a new genre, not just because i was using an SLR, but because I didn't have a big fancy telephoto lens to go after wildlife. I was going to have to shoot something different. I decided to shoot a family event because it was people who meant something to me, and it was a familiar setting. I'll share a selection of images here and let you be the judge.
...
I found this experience incredibly rewarding. From setting my exposure, composing, composing again, checking, and then pulling the shutter. The process is very deliberate. There is a satisfying clunk as the mirror slaps up and the shutter whips across. The process, a cliche word I know, is amazing. These images are highly sentimental, and hold value in pretty much only that regard. Most importantly, they are photographs that I created. 
...
I found the chemicals I needed online and ordered them from WEX. I picked up a Patterson development tank from Amazon along with some other bits like a film squeegee and a dark bag (basically a light-proof t-shirt with a zip at the bottom). The development process was tense to start with. I used an app to help me time the stages. I prepared and got everything read, then just cracked on. 

The relief and sheer amazement I felf when I pulled the roll of film out of the tank was brilliant. I remember having an actual grin on my face that it had worked! In fact I was that amazed I took a selfie with the negatives as the hung to dry.
...
Since this first run, I've put about 10 rolls through the camera, including a very-out-of-date roll of colour film. Below are some highlight images that I really like, for more do check out my [[3.0 - 📷 Photography/3.1 - 🏞️ Galleries/3.1.4 - 🚀 Other/3.1.4.2 - Film Photography\|Film Photography]] gallery.
...
*Exploring the beautiful canals of Amsterdam. This was a great trip, we saw so much incredible art and history. It was amazing Amsterdam is more than just sex and drugs.*
